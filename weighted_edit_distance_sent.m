function [dist,L] = weighted_edit_distance_sent(sent1, sent2, weight1, weight2)
...
%do BC's
L(:,1) = ([0:L1-1] .* [0 L1 * weight1])';
L(1,:) = [0:L2-1] .* [0 L2 * weight2];

m4=0;%loop invariant
for idx = 2:L1;
    for idy = 2:L2
        if strcmp(sent1{idx-1}, sent2{idy-1}) == 1
            score = m;
        else
